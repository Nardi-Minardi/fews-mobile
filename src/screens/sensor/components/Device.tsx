      ...
      <View style={styles.overlay}>
        <View style={styles.modalContainer}>
          ...
          <View style={styles.tabContainer}>
            ...
            >
              <Text style={activeTab === 'all' ? styles.tabTextActive : styles.tabText}>All</Text>
            </TouchableOpacity>
            {deviceTagData?.map((tag: any) => (
              <TouchableOpacity
                key={tag.id}
                style={[styles.tabButton, activeTab === tag.name && styles.tabButtonActive]}
                onPress={() => setActiveTab(tag.name)}
              >
                <Text style={activeTab === tag.name ? styles.tabTextActive : styles.tabText}>{tag.name}</Text>
              </TouchableOpacity>
            ))}
          </View>
